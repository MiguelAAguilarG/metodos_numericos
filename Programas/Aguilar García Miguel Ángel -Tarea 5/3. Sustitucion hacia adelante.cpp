...
double sum;double ma[100][100];double ma2[100][100],ma3[100][100];
FILE *f1,*f2;
...
do
{
      ...
      system("cls");
      fclose(f1);
      printf("3. Sustitucion hacia adelante\n");
      printf("Para la matriz TRIANGULAR INFERIOR 'L'\n");
      printf("Desea:\
