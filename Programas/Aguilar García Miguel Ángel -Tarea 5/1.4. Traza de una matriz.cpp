...
int i=1,j=1,n=0,m=0,r=0,e=0,t=0,q=0,x=0,nn=0,mm=0,k=0;
char op,a,c,d[40],cc; 
double sum=0;double ma[100][100];
FILE *f1,*f2;
...
do
{
      ...
      system("cls");
      fclose(f1);
      printf("1.4. Traza de una matriz\n");
...
if(nn!=mm)
{
printf("\n\nError. El numero de columnas y de filas no es el mismo\npor lo tanto no es una matriz cuadrada");
       system("pause");
       exit(0);
} 
...
/*Traza de una matriz*/
system("cls");        
printf("La traza de la matriz 'A' es: ");
