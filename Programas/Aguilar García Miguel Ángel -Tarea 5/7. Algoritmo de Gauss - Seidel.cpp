...
double sum0=0,sumn=0;double ma[100][100];double ma2[100][100],ma3[100][100],maux3[100][100],tol=0,er1=0,er2=0,max=0,res[100],sumaux3=0,suma3=0,tol2=0,ma3old[100][100];
FILE *f1,*f2,*f3;
...
do
{
      ...
      system("cls");
      fclose(f1);
      printf("7. Algoritmo de Gauss - Seidel\n");
...
for(i=1;i<=mm;i++)
{
sumaux3=sumaux3+maux3[i][1]*maux3[i][1];
}
...
for(i=1;i<=mm;i++)
{
suma3=suma3+ma3old[i][1]*ma3old[i][1];
}
suma3=sqrt(suma3);
