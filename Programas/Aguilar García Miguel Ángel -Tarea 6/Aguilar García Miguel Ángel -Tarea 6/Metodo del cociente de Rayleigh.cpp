...
/*Metodo de cociente de Rayleigh*/
...
do
{
      ...
      system("cls");
      fclose(f1);
      printf("Metodo de cociente de Rayleigh\n");
...
/*Producto de 'xoldt' por 'y'*/
auxb=0;               
      for(k=1;k<=mm;k++)
      {
      auxa[k]=xoldt[1][k]*y[k][1];          
      }
...
/*Producto de 'xoldt' por 'xold'*/
auxb=0;               
      for(k=1;k<=mm;k++)
      {
      auxa[k]=xoldt[1][k]*xold[k][1];          
      }
...
/*Division de 'yu' entre 'yl'*/
amnew=yu/yl;                
/****************/

/*Division de 'y' entre 'amnew'*/
   for(i=1;i<=mm3;i++)
   {
   xnew[i][1]=(y[i][1])/amnew;          
   }               
/****************/
